...
export default function ReviewNav({ darkSwitch, darkMode, setDarkMode }) {
  ...
  return (
    <nav className=" sticky w-full h-fit bg-neutral-300 dark:bg-neutral-900 bottom-0 grid grid-cols-2 justify-items-center p-2 border-t-4 border-neutral-900 dark:border-neutral-300 sm:w-1/2 xl:w-1/3 2xl:w-1/4">
